...
class CryptoOracle:
    ...
    def get_token_price_from_coinbase(self, start_date, end_date, interval_sec = 300):
        ...
        if start_date and end_date:
            usd_pair_df = HistoricalData(self.pair, interval_sec, start_date, end_date).retrieve_data()
        elif not end_date:
            usd_pair_df = HistoricalData(self.pair, interval_sec, start_date).retrieve_data()
